...
OMASGAN performs automatic negative data augmentation and model retraining for AD by combining negative and positive training and by eliminating the need for feature extraction, human intervention, and dataset-dependent heuristic techniques because they do not scale (aim of deep learning), and this strengthens the applicability and generalization of the proposed model. The negative data augmentation strategy introduced in (Sinha et al., 2021) uses a restrictive and limiting definition of anomaly, creating OoD samples in an ad hoc way and not covering the OoD part of the data space. In addition, the methodology proposed in (Sinha et al., 2021) does not scale due to feature extraction and human intervention and we note that one of the main aims of deep learning is to eliminate feature engineering and feature extraction.
...
Project Website: [OMASGAN Project](https://anonymous.4open.science/r/d64e88f2-ec7f-4540-95f9-a681948baa69/).

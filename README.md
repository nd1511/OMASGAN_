...
OMASGAN performs automatic negative data augmentation and retraining by eliminating the need for feature extraction and human intervention because they do not scale (aim of deep learning), and this strengthens the applicability and generalization of our model. The methodology proposed in (Sinha et al., 2021) does not scale due to feature extraction and human intervention and we note that one of the main aims of deep learning is to eliminate feature engineering and feature extraction.

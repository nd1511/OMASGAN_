...
Our negative data augmentation methodology: OMASGAN generates minimum anomaly score OoD samples around the data points by using a strictly decreasing function of a distribution metric between the boundary samples and the data.
...
Example usage: python train_Task1_f-GAN_Proof_of_Concept.py, python -m train_Task1_f-GAN_Proof_of_Concept, python Task1_MNIST_f-GAN_Proof_of_Concept.py, or python Task1_MNIST2_f-GAN_Proof_of_Concept.py

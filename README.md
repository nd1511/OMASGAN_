...
Also, thanks to the code repositories: [f-GAN](https://github.com/nowozin/mlss2018-madrid-gan), [Negative-Data-Augmentation](https://anonymous.4open.science/r/99219ca9-ff6a-49e5-a525-c954080de8a7/), [Negative-Data-Augmentation-Paper](https://openreview.net/forum?id=Ovp8dvB8IBH), and [BigGAN-PyTorch](https://github.com/ajbrock/BigGAN-PyTorch)
